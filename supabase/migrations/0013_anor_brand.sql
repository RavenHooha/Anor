-- Apply to existing projects so the push trigger fallback title matches the
-- renamed app. Updates both functions in place; nothing else changes.
-- (Fresh setups using 0011 + 0012 already have "Anor" since those source files were updated.)
